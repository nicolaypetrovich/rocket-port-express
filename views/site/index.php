    ...
    <div class="container">
                ...
                <li class="main-hat__item">
                    <a href="calculate" class="main-hat__link d-flex align-items-center">
                        <?php if (null != $meta['index_block1_img1']->media): ?>
                            <img src="<?= $meta['index_block1_img1']->media->getImageOfSize(81, 106, 100); ?>"
                                 alt="<?= $meta['index_block1_img1']->media->alt; ?>">
                        <?php endif; ?>
                        <span class="red">
                ...
                <li class="main-hat__item">
                    <a href="tracking" class="main-hat__link d-flex align-items-center">
                        <?php if (null != $meta['index_block1_img2']->media): ?>
                            <img src="<?= $meta['index_block1_img2']->media->getImageOfSize(81, 106, 100); ?>"
                                 alt="<?= $meta['index_block1_img2']->media->alt; ?>">
                        <?php endif; ?>
                        <span class="red">
                ...
                <li class="main-hat__item">
                    <a href="#faq__popup" class="main-hat__link d-flex align-items-center popup-with-form">
                        <?php if (null != $meta['index_block1_img3']->media): ?>
                            <img src="<?= $meta['index_block1_img3']->media->getImageOfSize(81, 106, 100); ?>"
                                 alt="<?= $meta['index_block1_img3']->media->alt; ?>">
                        <?php endif; ?>
                        <span class="red">
        ...
        <div class="main-banner">
            <?php if (null != $meta['index_block2_img']->media): ?>
                <img src="<?= $meta['index_block2_img']->media->getImageOfSize(358, 1171); ?>"
                     alt="<?= $meta['index_block2_img']->media->alt; ?>">
            <?php endif; ?>
    ...
    <div class="container">
        ...
        <div class="services__list">
            ...
            <div class="services__item">
                <?php foreach ($icons_media as $media):?>
                <?php if($icons['image'.$i]==$media['id']):?>
                    <div class="services__icon">
                    <img src="<?=$media->getImageOfSize();?>" alt="<?=$media->alt;?>">
                </div>
                <?php break; endif; ?>
                <?php endforeach; ?>
